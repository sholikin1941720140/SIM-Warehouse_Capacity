                ...
                <div class="card-body">
                    <form method="post" action="{{ route('kapsrak.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="panjang" name="panjang" onchange="updateVolume()">
                        </div>

						<div class="form-group">
                            <label for="lebar">Lebar</label>
                            <input type="text" class="form-control" id="lebar" name="lebar" onchange="updateVolume()">
                        </div>
